...
class FilesController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','create','update','admin','delete','list','SearchFile'),
				'users'=>array('*'),
			),
	...
	public function actionSearchFile()
	{
		...
		if(isset($_POST['Files'])){
			$query = $_POST['Files']['SUBJECT'];
			$result = Yii::app()->db->createCommand("SELECT SUBJECT, NUMBER FROM tbl_files WHERE SUBJECT LIKE '%$query%'")->queryAll();
			foreach($result as $file){
				array_push($searchedFiles, array($file['SUBJECT'], $file['NUMBER']));
			}
		}
