...
<p>Expenditure including this bill: <span style="text-decoration: underline">Rs. <?php //echo $Appropriation->EXPENDITURE_INC_BILL;?>/-</span></p>
<p>Amount of work bill annexed: <span style="text-decoration: underline">Rs. <?php// echo $model->BILL_AMOUNT;?>/-</span></p>	
<p>Balance available: <span style="text-decoration: underline">Rs. <?php //echo $Appropriation->BALANCE;?>/-</span></p>
