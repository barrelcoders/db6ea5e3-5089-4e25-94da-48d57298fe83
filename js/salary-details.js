...
function saveSalaryAjax(emp_id, month, year, bill_id, name, format, parent_id){
	var parent = 'div.tabcontent#'+parent_id;
	var SALARY = {
		'IS_SALARY_BILL': 1,
		...
		'YEAR': year,
		'BILL_ID_FK': bill_id,
		'BASIC': $(parent).find("#SAL-BASIC").val(),
		'SP': $(parent).find("#SAL-SP").val(),
		'PP': $(parent).find("#SAL-PP").val(),
		'CCA': $(parent).find("#SAL-CCA").val(),
		'HRA': $(parent).find("#SAL-HRA").val(),
		'DA': $(parent).find("#SAL-DA").val(),
		'TA': $(parent).find("#SAL-TA").val(),
		'WA': $(parent).find("#SAL-WA").val(),
		'IT': $(parent).find("#SAL-IT").val(),
		'CGHS': $(parent).find("#SAL-CGHS").val(),
		'LF': $(parent).find("#SAL-LF").val(),
		'CGEGIS': $(parent).find("#SAL-CGEGIS").val(),
		'CPF_TIER_I': $(parent).find("#SAL-CPF_TIER_I").val(),
		'CPF_TIER_II': $(parent).find("#SAL-CPF_TIER_II").val(),
		'MISC': $(parent).find("#SAL-MISC").val(),
		'PLI': $(parent).find("#SAL-PLI").val(),
		'COURT_ATTACHMENT': $(parent).find("#SAL-COURT_ATTACHMENT").val(),
		'PT': $(parent).find("#SAL-PT").val(),
		'CCS': $(parent).find("#SAL-CCS").val(),
		'LIC': $(parent).find("#SAL-LIC").val(),
		'ASSOSC_SUB': $(parent).find("#SAL-ASSOSC_SUB").val(),
		'MAINT_JAYAMAHAL': $(parent).find("#SAL-MAINT_JAYAMAHAL").val(),
		'MAINT_MADIWALA': $(parent).find("#SAL-MAINT_MADIWALA").val(),
		'IS_HBA_RECOVERY': $(parent).find("#SAL-IS_HBA_RECOVERY").val(),
		'HBA_TOTAL': $(parent).find("#SAL-HBA_TOTAL").val(),
		'HBA_INST': $(parent).find("#SAL-HBA_INST").val(),
		'HBA_EMI': $(parent).find("#SAL-HBA_EMI").val(),
		'HBA_BAL': $(parent).find("#SAL-HBA_BAL").val(),
		'IS_MCA_RECOVERY': $(parent).find("#SAL-IS_MCA_RECOVERY").val(),
		'MCA_TOTAL': $(parent).find("#SAL-MCA_TOTAL").val(),
		'MCA_INST': $(parent).find("#SAL-MCA_INST").val(),
		'MCA_EMI': $(parent).find("#SAL-MCA_EMI").val(),
		'MCA_BAL': $(parent).find("#SAL-MCA_BAL").val(),
		'IS_COMP_RECOVERY': $(parent).find("#SAL-IS_COMP_RECOVERY").val(),
		'COMP_TOTAL': $(parent).find("#SAL-COMP_TOTAL").val(),
		'COMP_INST': $(parent).find("#SAL-COMP_INST").val(),
		'COMP_EMI': $(parent).find("#SAL-COMP_EMI").val(),
		'COMP_BAL': $(parent).find("#SAL-COMP_BAL").val(),
		'REMARKS': $(parent).find("#SAL-REMARKS").val(),
		'GROSS': $(parent).find("#gross-components").val(),
		'DED': $(parent).find("#ded-components").val(),
		'NET': $(parent).find("#net-components").val(),
		'OTHER_DED': $(parent).find("#other-ded-components").val(),
		'AMOUNT_BANK': $(parent).find("#credit-component").val(),
	};
