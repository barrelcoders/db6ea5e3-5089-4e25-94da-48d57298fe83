...
?>
<h3 style="text-transform: uppercase;text-align:center;text-decoration:underline;">Format of Schedule of Government's Contribution  towards Tier-I  and Tier-II of New pension Scheme for the month of <?php echo date('M-Y', strtotime($model->CREATION_DATE))?></h3>
<h3 style="text-transform: uppercase;text-align: center">BILL NO: <?php echo $model->NILL_BILL_NO; ?></h3>
<table class="pay-schedule-table">
	...
	<?php 
		...
		$criteria->condition = 't.BILL_ID_FK='.$model->ID.' AND (t.CPF_TIER_I > 0  OR t.CPF_TIER_II > 0)';
	...
	<tfoot>
		...
		?>
		<th class="small-xx"><?php echo $CPF_TIER_I;?></th>
		<th class="small-xx">
			<?php 
