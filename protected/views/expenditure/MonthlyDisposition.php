	...
	<div style="width: 219px; height: 700px;">
		<div class="" style="padding: 0px;    margin-top: 100px; width: 219px;padding-top: 0px!important;">
			<ul class="side-menu-additional-list" id="footer_action" style="display:none;">
				<li><a id="Monthly_Disposition_Cover" target="_blank" ><span class="tbl-row"><span class="tbl-cell tbl-cell-caption">Cover Letter</span></span></a></li>
				<li><a id="Monthly_Disposition_Data" target="_blank" ><span class="tbl-row"><span class="tbl-cell tbl-cell-caption">Disposition Data</span></span></a></li>
...
<script>
	$(document).ready(function(){
		$('#btnSubmit').click(function(){debugger;
			...
			$('#Monthly_Disposition_Cover').attr('href', '<?php echo Yii::app()->createUrl('Expenditure/Monthly_Disposition_Cover_letter'); ?>'+'&Month='+month+'&Year='+year);
			$('#Monthly_Disposition_Data').attr('href', '<?php echo Yii::app()->createUrl('Expenditure/Monthly_Disposition_Data'); ?>'+'&Month='+month+'&Year='+year);
			$('#footer_action').show();
		});
