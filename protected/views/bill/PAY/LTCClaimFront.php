...
<table class="one-table">
	...
	?>
		...
		<td style="vertical-align: top;">Rs. <?php echo SalaryDetails::model()->find('BILL_ID_FK='.$model->ID)->LTC_HTC_GROSS; ?></td>
		<td style="vertical-align: top;">Rs. <?php echo SalaryDetails::model()->find('BILL_ID_FK='.$model->ID)->LTC_HTC_ADVANCE; ?></td>
