...
?>
<h3 style="text-transform: uppercase;text-align:center;">SCHEDULE SHOWING THE RECOVERY OF Credit Co. Society IN R/O <?php echo ($model->BILL_TYPE == 1)? "OPS":"NPS"; ?> STAFF OF  <?php echo $master->DEPT_NAME?>FOR THE MONTH OF <?php echo date('M-Y', strtotime($model->CREATION_DATE))?></h3>
...
<table class="pay-schedule-table small">
	<thead>
		<tr>
			...
			<?php } ?>
			<th class="small-xx">Credit Co. Society </th>
		</tr>
	</thead>
	<?php 
		$i = 1;	
		...
		$criteria->condition = 't.BILL_ID_FK='.$model->ID.' AND t.CCS > 0';;
...
<p style="text-align: center; margin-top: 30px;"><b><?php echo $this->amountToWord($CCS);?><b></p>
