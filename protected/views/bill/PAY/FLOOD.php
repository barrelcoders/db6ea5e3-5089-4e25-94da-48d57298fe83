...
<table class="pay-schedule-table small">
	...
	<tbody>
		...
		<tr>
			...
			<td class="small-xx"><?php echo $salary->FLOOD_TOTAL; ?></td>
			<td class="small-xx"><?php echo $salary->FLOOD_INST; ?></td>
			<td class="small-xx"><?php echo $salary->FLOOD_BAL; ?></td>
		</tr>
		<?php 
			$i++;
		} ?>
	...
	<tfoot>
		...
		<th class="small right-br"></th>
		<th class="small-xx"><?php $FLOOD_EMI = Yii::app()->db->createCommand("SELECT SUM(FLOOD_EMI) as FLOOD_EMI FROM tbl_salary_details WHERE BILL_ID_FK = $model->ID AND YEAR = $model->YEAR AND MONTH = $model->MONTH;")->queryRow()['FLOOD_EMI']; echo $FLOOD_EMI;?></th>
		<th class="small-xx"><?php echo $salary->FLOOD_TOTAL; ?></th>
		<th class="small-xx"></th>
		<th class="small-xx"><?php echo $salary->FLOOD_BAL; ?></th>
	</tfoot>
</table>
