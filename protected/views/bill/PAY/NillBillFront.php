...
<div style="display: block;border-bottom: 1px solid #000;min-height: 70px;margin-bottom: 5px;position: relative;">
	<div style="display: inline-block;float: left;width: 50%;">
	  ...
	  <p style="margin-bottom:5px;font-size: 10px;"><strong>(i) Bill No and  Date:-	</strong><span style="border-bottom: 1px dotted #000;"><?php echo $model->NILL_BILL_NO; ?></span></p>
	  <p style="margin-bottom:5px;font-size: 10px;"><strong>(ii)Token No. and Date :</strong></p>
	  <p style="margin-bottom:5px;font-size: 10px;"><strong>(iii) Voucher no. and Date : <span style="border-bottom: 1px dotted #000;font-weight: bold;font-size: 13px;">(NILL BILL)</span></strong></p>
	</div>
</div>
...
<div style="width: 100%;position:relative;">
	...
	<div style="width: 33%;min-height: 425px;display: inline-block;float: left;font-size: 10px;position: relative;">
		...
		<?php 		
			...
			?>
		<p style="font-weight: bold;font-size: 12px;">Government's Contribution : Tier-I <span style="float: right;font-weight: bold;margin-right: 10px;">Rs.<?php echo $CPF_TIER_I?></span></p><br><br>
		<p style="font-weight: bold;font-size: 10px;">Total C/o <span style="float: right;font-weight: bold;margin-right: 10px;">Rs.<?php echo $CPF_TIER_I?></span></p><br>
	...
	<div style="width: 33%;min-height: 425px;display: inline-block;float: left;position: relative;">
		...
		<p style="font-weight: bold;font-size: 11px;">Total B/F <span style="float: right;margin-right: 10px;font-style: italic">Rs.<?php echo $CPF_TIER_I?></span></p><br>
		...
		<p><span style="font-weight: bold;font-size: 11px;">(A)</span> <span style="font-weight: bold;font-size: 11px;"> -- Total	</span><span style="float: right;margin-right: 10px;font-weight: bold;">Rs.<?php echo $CPF_TIER_I;?></span></p>
		
	</div>
	<div style="width: 33%;min-height: 425px;display: inline-block;float: left;position: relative;">
		<div style="border: 1px solid;height: 425px;position: absolute;width: 73px;right: 5px;top: 0;"></div>
		<p><span style="font-weight: bold;font-size: 11px;">Detailed Heads</span></p><br><br><br><br>
		
		<p style="font-size: 11px;font-weight: bold;">Expenditure Awaiting Transfer :</p>
		<p style="font-size: 11px;font-weight: bold;">I. Grand Total :-<span style="font-size: 11px;float: right;margin-right: 10px;display: inline-block;width: 60%;"><span style="float: right;font-style: italic;">Rs.<?php echo $CPF_TIER_I;?></span></span></p>
		<p style="font-size: 11px;">(a) LESS deductions/recoveries adjustable by Pay <br> and Accounts Officer as per details <span style="float: right;font-weight: bold;margin-right: 10px;">Rs.<?php echo $CPF_TIER_I;?></span></p><br>
		...
		<p style="font-size: 11px;font-weight: bold;">II. Total deductions / recoveries <span style="float: right;font-weight: bold;margin-right: 10px;">Rs.<?php echo $CPF_TIER_I;?></p><br>
		...
		<p style="margin-bottom: 20px;"><span style="font-weight: bold;font-size: 11px;">(i) Cheque for self / s per detail given in the bill --</span><span style="font-size: 13px;float: right;margin-right: 10px;display: inline-block;width: 70%;font-weight: bold;">To DDO :<span style="float: right;font-style: italic;"></span></span></p>
		<p style="margin-bottom: 20px;"><span style="font-weight: bold;font-size: 11px;">(ii) Demand Draft in favour of :</span><span style="font-size: 12px;float: right;margin-right: 10px;display: inline-block;width: 70%;font-weight: bold;"></span></p>
		<p ><span style="font-weight: bold;font-size: 11px;"></span><span style="font-size: 13px;float: right;margin-right: 10px;display: inline-block;width: 70%;font-weight: bold;">(RUPEES NIL ONLY) :-<span style="font-weight: bold;font-size:12px;float: right;">Rs.<?php echo $CPF_TIER_I;?></span></p>
	</div>
</div>
<p style="text-align: center;font-weight: bold;font-size:11px;"><?php echo $this->amountToWord($CPF_TIER_I);?></p>
