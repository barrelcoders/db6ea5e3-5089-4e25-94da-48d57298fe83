...
class Investments extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('OTHER_INCOME, HOUSE_INCOME, BONUS, CEA_TUITION ,
			EL_ENCASH, LTC_HTC, UNIFORM, DA_TA_ARREAR_CPF, DA_TA_ARREAR, OTA_HONORANIUM, FINANCIAL_YEAR_ID_FK, EMPLOYEE_ID, 
