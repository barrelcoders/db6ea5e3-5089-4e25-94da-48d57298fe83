...
class Employee extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			FOLIO_NO, EIS_CODE', 'required'),
			array('NAME, NAME_HINDI, FIRST_NAME, MIDDLE_NAME, LAST_NAME, EMPLOYEE_CODE, EMPLOYEE_NAME_AND_CODE, AADHAR_NO, EMAIL_ID, EIS_CODE', 'length', 'max'=>100),
			...
			CGHS_CARD_NO ,EMPLOYEE_CODE_BY_EMPLOYER, MOBILE_NO, AADHAR_NO, EMAIL_ID, IS_CGHS_CARD_HOLDER, IS_EX_SERVICE, GPF_SUBSCRIPTION, EIS_CODE', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('EIS_CODE',$this->GPF_SUBSCRIPTION,true);
