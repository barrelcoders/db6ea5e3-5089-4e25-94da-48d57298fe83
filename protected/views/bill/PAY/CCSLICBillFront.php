...
<div style="display: block;border-bottom: 1px solid #000;min-height: 70px;margin-bottom: 5px;position: relative;">
	<div style="display: inline-block;float: left;width: 50%;">
	  ...
	  <p style="margin-bottom:5px;font-size: 10px;"><strong>(i) Bill No and  Date:-	</strong><span style="border-bottom: 1px dotted #000;"><?php echo $model->LIC_DED_BILL_NO; ?></span></p>
...
<div style="width: 100%;position:relative;">
	...
	<div style="width: 33%;min-height: 425px;display: inline-block;float: left;font-size: 10px;position: relative;">
		...
		<?php 		
			$LIC = Yii::app()->db->createCommand("SELECT SUM(LIC) as LIC FROM tbl_salary_details WHERE BILL_ID_FK = $model->ID AND YEAR = $model->YEAR AND MONTH = $model->MONTH;")->queryRow()['LIC']; 
			$CCS = Yii::app()->db->createCommand("SELECT SUM(CCS) as CCS FROM tbl_salary_details WHERE BILL_ID_FK = $model->ID AND YEAR = $model->YEAR AND MONTH = $model->MONTH;")->queryRow()['CCS']; 
		?>
	...
	<div style="width: 33%;min-height: 425px;display: inline-block;float: left;position: relative;">
		...
		<p style="font-size: 11px;font-weight: bold;"><span style="font-size: 11px;float: right;margin-right: 10px;display: inline-block;width: 70%;">LIC:-<span style="float: right;font-style: italic;">Rs.<?php echo $LIC;?></span></span></p>
		<p style="font-size: 11px;font-weight: bold;"><span style="font-size: 11px;float: right;margin-right: 10px;display: inline-block;width: 70%;">Credit Co. Society:-<span style="float: right;font-style: italic;">Rs.<?php echo $CCS;?></span></span></p>
		<br>
		<p style="font-size: 11px;font-weight: bold;">Expenditure Awaiting Transfer :</p>
		<p style="font-size: 11px;font-weight: bold;">I. Grand Total :-<span style="font-size: 11px;float: right;margin-right: 10px;display: inline-block;width: 60%;"><span style="float: right;font-style: italic;">Rs.<?php echo $LIC+$CCS;?></span></span></p>
		...
		<p ><span style="font-weight: bold;font-size: 11px;"></span><span style="font-size: 13px;float: right;margin-right: 10px;display: inline-block;width: 70%;font-weight: bold;">Total :-<span style="font-weight: bold;font-size:12px;float: right;">Rs.<?php echo $LIC+$CCS;?></span></p>
	</div>
</div>
<p style="text-align: center;font-weight: bold;font-size:11px;"><?php echo $this->amountToWord($LIC+$CCS);?></p>
