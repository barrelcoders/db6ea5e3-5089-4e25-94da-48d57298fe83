...
?>
<p>Appropriation for the current year <span style="text-decoration: underline"><?php echo Budget::model()->findByPK(7)->AMOUNT;?></span></p>
<p>Expenditure including this bill: <span style="text-decoration: underline"><?php echo $Appropriation->EXPENDITURE_INC_BILL;?></span></p>
<p>Amount of work bill annexed: <span style="text-decoration: underline"><?php echo $model->BILL_AMOUNT;?> (Including PT)</span></p>	
<p>Balance available: <span style="text-decoration: underline"><?php echo $Appropriation->BALANCE;?></span></p>
