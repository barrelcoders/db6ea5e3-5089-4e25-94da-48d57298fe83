...
<table class="pay-schedule-table">
	<thead>
		<tr>
			...
			<th class="small-xx">EL ENCASHMENT</th>
	...
	<tbody>
		...
		<tr>
			...
			<td class="small-xx"><?php echo $salary->EL_ENCASHMENT; ?></td>
	...
	<tfoot>
		...
		<th class="small right-br"></th>
		<th class="small-xx"><?php $EL_ENCASHMENT = Yii::app()->db->createCommand("SELECT SUM(EL_ENCASHMENT) as EL_ENCASHMENT FROM tbl_salary_details WHERE BILL_ID_FK = $model->ID AND YEAR = $model->YEAR AND MONTH = $model->MONTH;")->queryRow()['EL_ENCASHMENT'];echo $EL_ENCASHMENT;?></th>
